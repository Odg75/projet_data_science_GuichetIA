...
// Detection de la demarche a partir du texte de la question
...
// Genere les suggestions en fonction de la demarche detectee dans la question posee
...
const DEMARCHE_LINKS = {
  cnib:                   { official: "https://oni.bf/nos-prestations/cnib/", label: "ONI - Office National d'Identification" },
  passeport:              { official: "https://oni.bf/nos-prestations/passeport/", label: "ONI - Office National d'Identification" },
...
export default function ChatDashboard({ onNavigate, initialQuestion }) {
  ...
  async function handleSend(question) {
    ...
    try {
      ...
      // Suggestions basees sur la demarche detectee localement
